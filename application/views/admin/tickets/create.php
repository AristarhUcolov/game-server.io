...
<?php echo $header ?>
 ...
 <div class="form-group">
      <label for="text" class="col-sm-3 control-label">ИД Клиента:</label>
      <div class="col-sm-5">
       <input type="text" class="form-control" id="pid" name="pid" placeholder="Ид клиента, например 1">
      </div>
     </div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<textarea class="form-control" id="text" name="text" rows="5" placeholder="Сообщение..."></textarea>
						</div>
					</div>
					<div class="form-group">
